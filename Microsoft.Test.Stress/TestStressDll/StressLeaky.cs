...
namespace TestStressDll
{
    ...
    public class StressLeakyClass
    {
        ...
        {
            readonly byte[] arr;
            public BigStuffWithLongNameSoICanSeeItBetter(StressLeakyClass myClass, int initSize = 1024 * 1024 * 2) // over our 1M threshold
            {
                arr = new byte[initSize];
                myClass.OptionsChanged += (o, e) =>
                  {
                      myClass.TestContext.WriteLine($"In optionsChanged");
                  };
            }
        ...
        public void Cleanup()
        {
            ...
            if (logger != null)
            {
                ...
                foreach (var logline in logger._lstLoggedStrings)
                {
        ...
        public async Task StressLeakyBadPerfCounterCatAsync()
        {
            ...
            try
            {
                ...
                _lst.Add(new BigStuffWithLongNameSoICanSeeItBetter(this));
            }
...
$"String and Type Count differences_{numIter}.txt",
        ...
        public async Task StressLeakyCustomThresholdAsync()
        {
            ...
            _lst.Add(new BigStuffWithLongNameSoICanSeeItBetter(this, initSize: (int)(thresh + 100000)));
        }
        ...
        public async Task StressLeakyVerifyDiffFileResultAsync()
        {
            ...
            catch (LeakException)
            {
                ...
                var logger = TestContext.Properties[StressUtil.PropNameLogger] as Logger;
                logger.LogMessage(File.ReadAllText(diffFile.filename));
